      ...
      <Grid inverted stackable>
        <Grid.Row>
          <Grid.Column width={3} style={{ paddingTop: '1.25rem' }}>
            <a href="http://drsous.herokuapp.com/recipes">
              <div style={styles.logo}>
                <Image src="/images/chefHatNoBackground.jpeg" size="small" shape="circular" centered />
                sous
              </div>
            </a>
            <a href="https://github.com/raguayo/raww">
              <Image src="/images/blueGithub.png" size="mini" shape="circular" centered />
            </a>
          </Grid.Column>
          <Grid.Column width={4}>
            <a href="https://www.linkedin.com/in/william-raedy-13a161147/">
              <Image src="/images/WillyRaedy.jpeg" size="small" shape="circular" centered />
              <Header inverted as="h4" content="Willy Raedy" textAlign="center" />
            </a>
          </Grid.Column>
          <Grid.Column width={4}>
            <a href="https://www.linkedin.com/in/alexander-j-stauter-7239ba93/">
              <Image src="/images/AlexStauter.jpeg" size="small" shape="circular" centered />
              <Header inverted as="h4" content="Alex Stauter" textAlign="center" />
            </a>
          </Grid.Column>
          <Grid.Column width={4}>
            <a href="https://www.linkedin.com/in/rick-aguayo/">
              <Image src="/images/RickAguayo.jpeg" size="small" shape="circular" centered />
