...
const updateRecipesTotal = (newQuantityObj, recipeId) => ({
  type: UPDATE_RECIPES_TOTAL,
  newQuantityObj,
  recipeId,
});
...
export const fetchGroceryListRecipes = () => dispatch =>
  axios
    .get('/api/grocery-list/recipes')
    .then(res => res.data)
    .then((recipes) => {
...
export const deleteRecipeFromList = recipeId => dispatch =>
  axios
    .delete(`/api/grocery-list/recipes/${recipeId}`)
    .then(res => res.data)
    .then(() => {
...
export const transferSavedRecipe = recipeId => dispatch =>
  axios
    .put(`/api/grocery-list/recipes/${recipeId}/transfer`)
    .then(res => res.data)
    .then((transferred) => {
